...
Adam optimizer: Optimization computed using numerical gradient results should satisfy the originally computed optimization
...
The hyperparameters for the adam optimizer are also fixed
========================================================================
