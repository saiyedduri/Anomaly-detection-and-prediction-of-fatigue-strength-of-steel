...
RMSProp optimizer: Optimization computed using numerical gradient results should satisfy the originally computed optimization
...
The hyperparameters for the RMSProp optimizer are also fixed
========================================================================
