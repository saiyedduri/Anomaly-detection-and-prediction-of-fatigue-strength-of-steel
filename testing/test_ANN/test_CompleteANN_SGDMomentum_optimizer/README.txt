...
SGDMomentum optimizer: Optimization computed using numerical gradient results should satisfy the originally computed optimization 
Here, optimization means updating weights and biases
------------------------------------------------------------------------

# Command used to run the program:
Run the test from the current directory as pytest -l (prints more details) / pytest -v (prints more details)
# Parameters: 
...
The hyperparameters for the SGDMomentum optimizer are also fixed
========================================================================
